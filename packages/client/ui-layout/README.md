...
- **Source editing is explicit** — the first editor covers `problem.md`; reads and saves go through the Host source bridge, require the Session's existing `workspace-write` policy, and surface revision conflicts instead of overwriting external changes.
