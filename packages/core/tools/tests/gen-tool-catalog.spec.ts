...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_agents', 'list_agents', 'lsp',
      'probhub_assemble', 'probhub_build', 'probhub_checkpoint', 'probhub_delivery_check',
      'probhub_generation_status', 'probhub_judge', 'probhub_judge_qa', 'probhub_mutation',
      'probhub_report', 'probhub_seal', 'probhub_stress', 'probhub_verify_package',
      'pwsh', 'pwsh', 'ralph',
